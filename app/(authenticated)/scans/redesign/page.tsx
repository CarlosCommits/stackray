...
const sampleScanData = {
  ...
  title: "The Entertainment Software Association - the ESA",
  technologies: {
  ...
  nucleiTechnologies: [
    { name: "nginx", matchedAt: "https://www.theesa.com/" },
    { name: "appnexus", matchedAt: "https://www.theesa.com/" },
    { name: "google-tag-manager", matchedAt: "https://www.theesa.com/" },
    { name: "google-font-api", matchedAt: "https://www.theesa.com/" }
  ],
  redirectChain: [
    { url: "https://theesa.com", statusCode: 301, location: "https://www.theesa.com/" },
    { url: "https://www.theesa.com/", statusCode: 200 }
  ],
  tls: {
    sni: "www.theesa.com",
    ...
    subjectAn: ["theesa.com", "www.theesa.com"]
  },
  dns: {
    a: ["23.185.0.253"],
  ...
  bodyDomains: [
    "nintendo.com", "tencentgames.com", "gmpg.org", "linkedin.com", "adsrvr.org",
    "wordpress.org", "nexon.com", "twitter.com", "doubleclick.net", "epicgames.com",
    "videogamepac.com", "icedcoffeeplease.com", "yoast.com", "adnxs.com", "amazongames.com",
    "capcomusa.com", "konami.com", "sonyinteractive.com", "ubisoft.com", "instagram.com",
    "gstatic.com", "googletagmanager.com", "xbox.com", "square-enix-games.com", "mattel.com",
    "riotgames.com", "roblox.com", "take2games.com", "warnerbrosgames.com", "fonts.googleapis.com",
    "facebook.com", "schema.org", "ea.com", "cdn-cookieyes.com", "disney.com", "x.com",
    "w3.org", "bandainamcoent.com", "netflix.com"
  ],
  bodyFqdns: [
    "www.epicgames.com", "www.nexon.com", "fonts.gstatic.com", "www.amazongames.com",
    "about.mattel.com", "www.xbox.com", "corp.roblox.com", "www.facebook.com", "acdn.adnxs.com",
    "ad.doubleclick.net", "insight.adsrvr.org", "www.tencentgames.com", "www.linkedin.com",
    "www.ea.com", "www.riotgames.com", "www.w3.org", "www.bandainamcoent.com", "games.disney.com",
    "www.googletagmanager.com", "ib.adnxs.com", "www.konami.com", "www.netflix.com",
    "www.take2games.com", "www.nintendo.com", "www.square-enix-games.com", "www.instagram.com",
    "www.theesa.com", "www.capcomusa.com", "www.ubisoft.com", "www.icedcoffeeplease.com"
  ],
  hashes: {
...
const sampleHistory = [
  ...
  { scanId: "4fad8012-1a2b-3c4d-5e6f-7a8b9c0d1e2f", date: "2026-03-15 11:30 AM", status: "completed", technologies: 19, issues: 12, finalUrl: "https://www.theesa.com/" },
]
...
const txtRecords = [
  ...
  "v=spf1 mx a ip4:64.190.48.74 ip4:96.86.20.225 include:u17186209.wl210.sendgrid.net include:spf.protection.outlook.com include:_spf.createsend.com -all",
  "6e618vmkm9qfk2ga76chs8lfvm"
]

const domainMetadata = {
  nameServers: ["KAYLEIGH.NS.CLOUDFLARE.COM", "SCOTT.NS.CLOUDFLARE.COM"],
  registrar: "Network Solutions, LLC",
  registrarEmail: "domain.operations@web.com",
  registrarPhone: "+1.8777228662",
  registrarUrl: "http://networksolutions.com",
  registrarIanaId: "2",
        ...
        <div className={layoutMode === "dashboard" ? "lg:col-span-2 space-y-4" : "space-y-4"}>
          ...
          >
            <div className="p-4 bg-[var(--surface-mid)]/20 rounded font-mono text-sm">
              ...
              <p className="text-[var(--muted-foreground)]">Sitemap: https://www.theesa.com/wp-sitemap.xml</p>
            </div>
          </CollapsibleSection>
          </div>
