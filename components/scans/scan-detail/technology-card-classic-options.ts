...
export type ClassicTechnologyCardThemeProfile = {
...
export const classicTechnologyCardThemeProfiles: Record<TechnologyCardStyle, ClassicTechnologyCardThemeProfile> = {
  stackray: {
    frameClass:
    ...
    itemDottedClass: "[background-image:radial-gradient(circle,rgba(245,158,11,0.62)_1px,transparent_1.5px)]",
    ...
    browserChromeClass: "border-amber-200/20 bg-[linear-gradient(180deg,rgba(245,158,11,0.16),rgba(0,0,0,0.22))]",
  ...
  sunset: {
    ...
    itemDottedClass: "[background-image:radial-gradient(circle,rgba(251,146,60,0.64)_1px,transparent_1.5px)]",
    ...
    browserChromeClass: "border-orange-100/20 bg-[linear-gradient(180deg,rgba(251,146,60,0.15),rgba(168,85,247,0.1)_48%,rgba(0,0,0,0.24))]",
  ...
  aurora: {
    ...
    itemDottedClass: "[background-image:radial-gradient(circle,rgba(45,212,191,0.62)_1px,transparent_1.5px)]",
    ...
    browserChromeClass: "border-cyan-100/18 bg-[linear-gradient(180deg,rgba(45,212,191,0.13),rgba(167,139,250,0.1)_48%,rgba(0,0,0,0.24))]",
  ...
  mono: {
    ...
    itemDottedClass: "[background-image:radial-gradient(circle,rgba(226,232,240,0.42)_1px,transparent_1.5px)]",
    ...
    browserChromeClass: "border-white/12 bg-[linear-gradient(180deg,rgba(255,255,255,0.08),rgba(0,0,0,0.24))]",
