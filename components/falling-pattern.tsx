...
export function FallingPattern({
	...
	const squareMask =
		`linear-gradient(90deg, ${backgroundColor} calc(50% - 2px), transparent calc(50% - 2px) calc(50% + 2px), ${backgroundColor} calc(50% + 2px)), ` +
		`linear-gradient(0deg, ${backgroundColor} calc(50% - 2px), transparent calc(50% - 2px) calc(50% + 2px), ${backgroundColor} calc(50% + 2px))`;
