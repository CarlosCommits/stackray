...
const envSchema = z.object({
  ...
  STACKRAY_HTTPX_BROWSER_HEADERS: z.enum(["true", "false"]).optional(),
  STACKRAY_HTTPX_TLS_IMPERSONATE: z.enum(["true", "false"]).optional(),
...
export const env = envSchema.parse({
  ...
  STACKRAY_HTTPX_BROWSER_HEADERS: process.env.STACKRAY_HTTPX_BROWSER_HEADERS,
  STACKRAY_HTTPX_TLS_IMPERSONATE: process.env.STACKRAY_HTTPX_TLS_IMPERSONATE,
