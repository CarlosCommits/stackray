...
describe("selectAuthoritativeScanResult", () => {
  it("prefers the row whose normalized urls match the primary target", () => {
    ...
    expect(selectAuthoritativeScanResult([subdomainRow, rootRow], "https://stripe.com")).toEqual(rootRow);
  });
  ...
  it("falls back to the first row when nothing matches the primary target", () => {
    ...
    expect(selectAuthoritativeScanResult([firstRow], "https://stripe.com")).toEqual(firstRow);
  });
  ...
  it("matches scheme-less stored primary targets against schemeful result urls", () => {
    ...
    expect(selectAuthoritativeScanResult([rootRow], "theesa.com/about")).toEqual(rootRow);
  });
