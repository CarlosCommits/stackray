...
const createMockResult = (overrides: Partial<ScanResultItem> = {}): ScanResultItem => ({
  ...
  bodyDomains: ["google.com", "facebook.com"],
  bodyFqdns: ["www.google.com", "api.facebook.com"],
  hashes: {
    bodyMd5: "abc123",
    bodySha256: "def456",
  },
...
describe("scan-detail-view-model", () => {
  ...
  describe("buildContentSignalsSection", () => {
    it("should build content signals section", () => {
      ...
      expect(section.contentLength).toBe(1024)
      expect(section.bodyDomains).toEqual(["google.com", "facebook.com"])
      expect(section.bodyFqdns).toEqual(["www.google.com", "api.facebook.com"])
      ...
      const result = createMockResult({
        nuclei: {
          ...
          run: {
            ...
            originalDomainTarget: "old-domain.com",
            finalDomainTarget: "new-domain.com",
          },
          findings: [
            {
              matchId: "finding-1",
