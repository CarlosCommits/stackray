  ...
  items: [
    {
      ...
      location: "https://primary.example.test/shop",
      ...
      dns: {
        ...
        cname: ["primary.example.test", "flywheel.netdna-cdn.com"],
      ...
      tls: {
        ...
        certificate: {
          subject: "CN=primary.example.test",
          ...
          subjectAltName: ["primary.example.test", "www.primary.example.test"],
          keyAlgorithm: "RSA",
          keySize: 2048,
      ...
      redirectChain: {
        ...
        items: [
          {
            url: "http://primary.example.test",
            statusCode: 301,
            location: "https://primary.example.test",
            contentLength: 0,
            responseTimeMs: 45,
          },
          {
      ...
      bodyDomains: ["primary.example.test", "google-analytics.com", "googleapis.com", "static-a.example.test", "fastly.net"],
      bodyFqdns: ["www.primary.example.test", "fonts.example.test", "ajax.googleapis.com", "cdn.fastly.net"],
      rawHttpx: {
        ...
        tls: {
          ...
          certificate: {
            ...
            subject_alt_name: ["primary.example.test", "www.primary.example.test"],
            key_algorithm: "RSA",
            key_size: 2048,
        ...
        favicon: "https://primary.example.test/favicon.ico",
        ...
        body_domains: ["primary.example.test", "google-analytics.com", "googleapis.com", "static-a.example.test", "fastly.net"],
        body_fqdns: ["www.primary.example.test", "fonts.example.test", "ajax.googleapis.com", "cdn.fastly.net"],
        header: {
          "server": "Flywheel/5.1.0",
