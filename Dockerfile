...
ARG HTTPX_REF=89a1173728f64e8f6a6d423f80aa14371616e8cd
...
ARG NUCLEI_TEMPLATES_REF=727a5239ab9d87521a936e79d4c97f987f74a02b
...
ENV BETTER_AUTH_SECRET=docker-build-placeholder-stackray-template-only
RUN pnpm build
